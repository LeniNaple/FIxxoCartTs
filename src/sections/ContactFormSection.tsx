...
const ContactFormSection: React.FC = () => {
  ...
  const handleTextAreaChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
      ...
      if (id === 'comments') {
        setErrors({...errors, [id]: validateText(id, value, 7)})
    }
  }
  ...
  return (
    <section className="contact-form mt-5">
      <div className="container">
        ...
        {
          failedSubmit ? ( <AlertNotification alertType='danger' title='Something went wrong!' text='Try sending another comment.' /> ) : (<></>)
        }
